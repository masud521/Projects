...
misspellings_uk <- c( "uk","scotland","england","ireland","u.k.",
                      "united kindom")
...
unknown_country <- c(
  "atlantis","canae",
  "earth","europe",
  "fear and loathing","i don't know anymore",
  "insanity lately","narnia",
  "soviet canuckistan","ud",
  "a tropical island south of the equator","denial",
  "eua","god's country",
  "neverland","one of the best ones", "see above",
